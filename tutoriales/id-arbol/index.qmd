...
Hemos identificado un yarumo y queremos agregarlo a OpenStreetMap (OSM). Para ello, utilizaremos el editor iD, el cual está integrado en la página de OSM. Es importante recordar que, para poder colaborar en OSM, es necesario tener una cuenta.
...
![Pantalla inicial del editor iD si ingresas por primera vez. La flecha indica la opción de **Editar ahora**.](images/jpg/01_id-home.jpg){#fig-01_id-home fig-align="center"}
...
![La flecha indica la opción **Configuración de fondo**.](images/jpg/02_fondo-configuracion.jpg){#fig-02_fondo-configuracion fig-align="center"}
...
![Opciones del menú **Fondo**. la flecha indica la opción **Personalizado**.](images/jpg/02.5_fondo-personalizado.jpg){#fig-02.5_fondo-personalizado fig-align="center"}
...
![Cómo agregar un punto en OpenStreetMap. La flecha indica dónde está el botón **Punto**.](images/jpg/06_agregar-punto.jpg){#fig-06_agregar-punto fig-align="center"}

Tras hacer clic en la botón **Punto**, el cursor cambia por una una cruz (![](images/svg/icon-plus.svg)). Al hacer clic en la ubicación del árbol, esto agrega un punto (![](images/svg/icon-point.svg)) en el mapa y se despliega el menú **Selecciona tipo de elemento**, como se muestra en la @fig-07_seleccionar-elemento. Este menú permitirá agregar las etiquetas apropiadas para mapear correctamente el árbol.

![Después de dar clic en la opción **Punto**, puedes agregar un punto en el mapa  e inmediatamente se despliega el menú **Selecciona tipo de elemento**. La flecha (**1**) indica un punto agregado en el mapa y la flecha (**2**) indica el campo de búsqueda.](images/jpg/07_seleccionar-elemento.jpg){#fig-07_seleccionar-elemento fig-align="center"}
...
![Opciones que se despliegan en el menú **Selecciona tipo de elemento** cuando se busca la palabra «árbol». La flecha **1** indica el campo de búsqueda. La flecha **2** indica la opción **Árbol de hoja ancha (perennifolio)**.](images/jpg/08_buscar-arbol.jpg){#fig-08_buscar-arbol fig-align="center"}
...
![Opciones que se despliegan en el menún **Editar elemento** después de seleccionar la opción **Árbol de hoja ancha (perennifolio)**. La flecha indica las opciones **Tipo de hoja** y **Ciclo de la hoja**.](images/jpg/09_editar-elemento.jpg){#fig-09_editar-elemento fig-align="center"}
...
![Opción **Agregando campo** en el menú **Editar elemento**. La flecha indica el listado que se despliega al hacer clic en la opción **Agregar campos**.](images/jpg/12_agregar-campo.jpg){#fig-12_agregar-campo fig-align="center"}
...
![Las opciones **Especies Wikidata**, **Wikidata** y **Wikipedia** en el menú  **Editar elemento**. La flecha **1** indica la opción **Especies Wikidata**. La flecha **2** indica la opción **Wikidata** y **Wikpedia**, todos con los valores de *Cecropia peltata*.](images/jpg/14_agregar-wikidata.jpg){#fig-14_agregar-wikidata fig-align="center"}
...
![Cómo agregar una etiqueta en el menú **Editar elemento**. La fecha **1** indica la sección de **Etiquetas**. La flecha **2** indica la opción **Agregar una etiqueta**.](images/jpg/15_agregar-etiqueta.jpg){#fig-15_agregar-etiqueta fig-align="center"}
...
![Cuadro en blanco que aparece después de hacer clic en **Agregar una etiqueta** en la sección **Etiquetas**. La flecha indica el cuadro en blanco.](images/jpg/16_agregar-etiqueta.jpg){#fig-16_agregar-etiqueta fig-align="center"}
...
![Agregando `species:es` como `key` y `Yarumo` como `value` en la sección de **Etiquetas**. La flecha indica donde se ha agregado la nueva etiqueta.](images/jpg/17_agregar-specieses.jpg){#fig-17_agregar-specieses fig-align="center"}
...
![Agregando `object:city` como `key` y `Medellín` como `value` en la sección de **Etiquetas**. La flecha indica dónde se ha agregado la nueva etiqueta.](images/jpg/18_agregar-ciudad.jpg){#fig-18_agregar-ciudad fig-align="center"}
...
![Cómo guardar los cambios hechos en OpenStreetMap. La flecha indica la opción **Guardar**.](images/jpg/19_revisar-subir.jpg){#fig-19_revisar-subir fig-align="center"}
...
![Menú que se despliegaLa tras hacer clic en la opción **Guardar**. La flecha indica el ménu **Subir a OpenStreetMap**.](images/jpg/20_subir_osm.jpg){#fig-20_subir_osm fig-align="center"}
...
![Añadiendo la información requerida para guardar los cambios en OpenStreetMap.](images/jpg/21_agregar-informacion.jpg){#fig-21_agregar-informacion fig-align="center"}
...
![Pantalla que aparece cuando los cambios se han subido correctamente a OpenStreetMap. La flecha **1** indica un mensaje de felicitación. La fecha **2** indica la opción para ver en OSM los cambios realizados.](images/jpg/22_edicion-completa.jpg){#fig-22_edicion-completa fig-align="center"}
...
![Pantalla donde se muestran los cambios realizados en OpenStreetMap. La flecha **1** indica un resumen de los datos. La fecha **2** indica donde se realizaron los cambios.](images/jpg/23_ver-cambios.jpg){#fig-23_ver-cambios fig-align="center"}
